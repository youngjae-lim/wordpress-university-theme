...
class Search {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-json/university/v1/search?keyword=' + this.searchField.val(), results => {
      this.resultsDiv.html(`
        <div class="row">
          <div class="one-third">
          ...
          <div class="one-third">
            ...
            ${results.professors.length ? '<ul class="link-list min-list">' : '<p>No professor matches that search. </p>'}
              ${results.professors.map(result => `<li><a href=${result.permalink}>${result.title}</a></li>`).join('')}
          ...
          <div class="one-third">
            ...
            ${results.events.length ? '<ul class="link-list min-list">' : '<p>No event matches that search. </p>'}
              ${results.events.map(result => `<li><a href=${result.permalink}>${result.title}</a></li>`).join('')}
